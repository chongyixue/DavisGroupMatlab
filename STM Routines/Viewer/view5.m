...
%caxis_min_p = libpointer('double',mean(map_lin) - 3*std(map_lin));
%caxis_max_p = libpointer('double',mean(map_lin) + 3*std(map_lin));

caxis_min_p = libpointer('double',caxis_min);
caxis_max_p = libpointer('double',caxis_max);
...
f3 = uimenu(f1,'Label','Histogram','Callback',{@histogram_Callback,map_lin,caxis_min_p,caxis_max_p});
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function set_color_Callback(hObject, evendata, IDL_Cmap)
    ...
    function histogram_Callback(hObject,evendata,map_lin,c_min_p,c_max_p)
        ...
        histogram_dialogue2(lyr_lin,c_min_p,c_max_p,main_axis)        
    end
end