...
std_left_edge = std(reshape(left_edge,256*256,1));
[r c] = find(left_edge <= mean_left_edge - 3*std_left_edge);
...
for i = 1:nr
    i
    for j = 1:nc
        pt1 = bottom_index(i,j) + 1; pt2 =  pt1 + 23;
...
%%
right_edge2 = gauss_filter_image(right_edge_b,20,20);
img_plot2(right_edge2,Cmap.Defect1,['right edge - pt1 = ' num2str(pt1) ' pt2 = ' num2str(pt2)]);
%%right_edge2 = gauss_filter_image(right_edge,15,15);
...
Bragg_x = [228 25 30 233];
Bragg_y = [17 27 241 231];
