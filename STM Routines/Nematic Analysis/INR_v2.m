...
function new_map = INR_v2(Cu_index,Ox_index1,Ox_index2,Oy_index1,Oy_index2,I_map,px_avg,patch_size)
...
for n = 1:nz
    ...
    for i = 1:size(Cu_index,1)           
        ...
        if (Oy_index1(i,1) ~= 0 && Oy_index1(i,2) ~= 0 && Ox_index1(i,1) ~= 0 && Ox_index1(i,2) ~= 0 ...
            ...
            Ix = (mean(mean(I_map.map(Ox_index1(i,1)-px_avg:Ox_index1(i,1)+px_avg,...
            ...
            Iy = (mean(mean(I_map.map(Oy_index1(i,1)-px_avg:Oy_index1(i,1)+px_avg,...
