...
local_scaled_spectra = gap_scale_local3(data,Cu_gap_map,Cu_index,Ox_index1,Ox_index2,Oy_index1,Oy_index2,avg_option2);
%figure; plot(local_scaled_spectra.e,squeeze(squeeze(local_scaled_spectra.spct(1,1,:))))
...
%%%%%%%%%%%%%%%%%%%%%%%%CALLBACK FUNCTIONS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
   function gen_Callback(hobject,eventdata)
        ...
        avg_spct = avg_nem_spect_scaled2(spct_obj,nem_img,Cu_gap_map,pos_thresh,neg_thresh);
