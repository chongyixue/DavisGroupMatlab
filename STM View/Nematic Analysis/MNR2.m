...
function new_data = MNR2(data,px_avg,varargin)
...
new_data.type = 3;
new_data.var =  [new_data.var(1) '_MNR_gnorm'];
new_data.ops{end+1} = ['MNR order parameter map with ' num2str(m) ' pixel average radius with global normalization'];
end
