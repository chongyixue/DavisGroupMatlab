...
fh=figure('Name', 'Export AVI Movie',...
    ...
    % Mac
    export_path = '/Users/YiXue/Documents/MATLAB/STMdata/PdTe2';  
    % Windows
...
%%%%%%%%%%%%%%%%%%%%%%%%%Callback Functions%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function open_dir_Callback(hObject, evendata)                           
        ...
        % Mac
        exp_directory = uigetdir('/Users/YiXue/Documents/MATLAB/STMdata/PdTe2');
        % Windows
%         exp_directory = uigetdir('C:\Users\Oliver\Documents\STMvideos');
    ...
    function export_Callback(hObject,evendata,map,rx,ry,energy,clmap,clbnd)
        ...
        if isempty(filename)
            ...
            directory;
            exp_movie_new(map,energy,rx,ry,directory,filename,clmap,clbnd,frps,quality);
%             exp_movie_new_rhominus(map,energy,rx,ry,directory,filename,clmap,clbnd,frps,quality);
        end
    end
