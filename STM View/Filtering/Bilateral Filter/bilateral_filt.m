%%%%%%%
% CODE DESCRIPTION:  B = bfilter2(A,W,SIGMA) performs 2-D bilateral filtering
%    for the grayscale or color image A. A should be a double precision 
%    matrix of size NxMx1 or NxMx3 (i.e., grayscale
...
function B = bilateral_filt(A,w,sigma)
