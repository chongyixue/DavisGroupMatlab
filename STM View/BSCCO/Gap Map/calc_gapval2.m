% Use MATLAB peak finding algorithm + polynomial fit to calculate gap value
function gap_val = calc_gapval2(x1,y1,dbl_pk_optn,dbl_pk_percent,pk_rng_optn) 
    %peaks1 = [];
    %mx = max(y1); mx = mx(1);
    %y1 = smooth(y1);
    [a b] = findpeaks(y1); % a = height, b = domain value
