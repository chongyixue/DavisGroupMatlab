function local_scaled_spectra = gap_scale_local2(data,Cu_gap_map,Cu_index,Ox_index1,Ox_index2,Oy_index1,Oy_index2,avg_option)
...
local_scaled_spectra.e = x_rescale  + (gap_min/Cu_gap_avg)/2/1000;
...
%         figure;
%         plot(xi,y_Ox1,'rx'); hold on; plot(x,Y_Ox1,'bx');
