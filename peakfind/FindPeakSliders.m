...
%
% Note: If the slider ranges are not appropriate for your data,d change 
...
WidthPoints=length(y)/length(x);  % Change to match approx. # of points in your peaks
%WidthPoints=length(y)/40;  % Change to match approx. # of points in your
%peaks
