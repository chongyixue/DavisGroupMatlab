...
obj_71001A01_T_dc.map =  obj_71001A01_T.map ;
[dx, dy] = determine_singleimp_center_single_peak(obj_71001A01_T_dc, 1, 61, 67, 4, 4, 'no');

% dx = 61;
% dy = 67;

comment = 'rectangle_blackdefect71001a01_detail60';

%change crop pixel size accordingly
[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71001a01_G, obj_71001A01_T, [dx, dy], 60);
%use clfdata to choose peaks (also = the map that appears after this)


%% sign-preserving scattering??
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho1] = singleimpuritypdte2analysis2(prft_data, [67,58], 2, 'ncircle',comment);
