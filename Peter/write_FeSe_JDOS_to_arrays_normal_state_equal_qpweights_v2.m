...
%% both gamma and X
for i=0:80
    s = strcat('C:\Users\pspra\OneDrive\VOSM\QPI layers\12212016_1.25meV_energy_broadening\mat\equal_qp_weights\','JDOS_g-0.1_f_0_low_eta_low_eta_', num2str(i), 'conv.mat');
%     s = strcat('C:\Users\Peter\OneDrive\VOSM\QPI layers\12212016_1.25meV_energy_broadening\mat\equal_qp_weights\','JDOS_g-0.1_f_0_low_eta_low_eta_', num2str(i), 'conv.mat');
    dummy = load(s);
    quartmap = dummy.rjd0;
