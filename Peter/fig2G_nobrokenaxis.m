...
for i=1 : 16
    ...
    if i==1
        plot(dummy(3), 0,'Marker', 'd', 'MarkerSize', p,'MarkerEdgeColor','k','MarkerFaceColor','k'); 
...
%         plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 0, 1]*cp(i),'MarkerFaceColor',[0, 0, 1]*cp(i)); 
        plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i-3+1), :),'MarkerFaceColor',color_map(cp(i-3+1), :)); 
        if i == 7 || i == 7 || i== 16 || i == 16  
            herrorbar(dummy(3), 0,  0.75*dummy(5),'k');  
        end
    end
end  
