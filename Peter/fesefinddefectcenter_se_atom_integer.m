function [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_se_atom_integer(data,gx, gy)
...
fe1locap =  atomic_pos(phase_map,0,0);
fe2locap =  atomic_pos(phase_map,0,0);
