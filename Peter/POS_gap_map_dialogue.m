function POS_gap_map_dialogue(data)
%% Changes made to BSSCO_gap_map_dialogue by Peter Sprau January 2014

fh = figure('Units','characters',...
'MenuBar','none',...
'Name','POS Gapmap Parameters',...
'NumberTitle','off',...
...
'String',{  'Peak Find'; 'Steepest slope'; 'Deviation from gap minimum'; 'Upper edge of slope'},...
'Style','popupmenu',...
'Value',1);
