...
comment = 'rectangle_defect71006a02';

%change crop pixel size accordingly
[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71006a02_G, obj_71006A02_T, [dx, dy], 50);
...
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho2] = singleimpuritypdte2analysis2(prft_data, [51,46], 2, 'ncircle',comment);
