...
clear all
close all
load C:\Users\Peter\Desktop\Cornell_PhD\Data\CeCoIn5_Rh0_3_data\10_21_13\CeCoRhIn_31021A00.mat
...
Gfilt = gauss_filter_image(G,4,2);
...
%FFT.map = map;
FFT=symmetrize_image_v2(FFT,'vh');
img_obj_viewer2(FFT);
...
[out1, out2] = coordinates_from_angle(in1,in2,angle,98);
% take the cut;
...
for i=1 : 9
    figure(i); plot(1:95,(ln_cut.cut(:,i)),'.k');
end
...
for i=1 : 9
    figure(i+10); plot(offset:98,(O(offset:end,i)),'.k');
