...
%%
xg_error = 0.75*[0.02576,0.01932,0.02576,0.02576,0.02576,0.02576,0.01932,0.02576,0.02576,0.01932,0.01932,0.01932,0.02576,0.02576];
...
plot(xg1(1), yg1(1),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(1,:),'MarkerFaceColor',color_map(1,:));
...
%     plot(xg1(i), yg1(i),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[1, 0, 0]*cp(i),'MarkerFaceColor',[1, 0, 0]*cp(i)); 
    plot(xg1(i), yg1(i),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i), :),'MarkerFaceColor',color_map(cp(i), :)); 
...
%     plot(0, dummy(3),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 1, 0]*cp(i),'MarkerFaceColor',[0, 1, 0]*cp(i));
    plot(0, dummy(3),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i), :),'MarkerFaceColor',color_map(cp(i), :));
    if i == 1 || i == 7|| i == 7 || i== 14  
        verrorbar(0, dummy(3),  dummy(5)/2,'k'); 
    end
end    
...
for i=1 : 17
    ...
    if i==1
        plot(dummy(3), 0.04,'Marker', 'd', 'MarkerSize', p,'MarkerEdgeColor','k','MarkerFaceColor','k'); 
        herrorbar(dummy(3), 0.04,  dummy(5)/2,'k');
    elseif i == 2 || i == 3
    else
...
%         plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 0, 1]*cp(i),'MarkerFaceColor',[0, 0, 1]*cp(i)); 
        plot(dummy(3), 0.04,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i-4+1), :),'MarkerFaceColor',color_map(cp(i-4+1), :)); 
        if i == 4 || i == 17 || i== 17 || i == 17  
            herrorbar(dummy(3), 0.04,  dummy(5)/2,'k');  
        end
    end
end  

plot(0, 0.04,'Marker', 'd', 'MarkerSize', p,'MarkerEdgeColor','k','MarkerFaceColor','w', 'LineStyle', '--');
...
ax2.LineWidth = 2;
ax2.XTick = linspace(0,0.14,8);
ax2.XTickLabel = {'0', '2','4', '6', '8', '10', '12', '14'}; 
ax2.YTick = linspace(0.04,0.18,8);
ax2.YTickLabel = {'0', '6','8', '10', '12', '14', '16', '18'}; 
%axis square
%axis off
