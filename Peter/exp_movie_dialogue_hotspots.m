function exp_movie_dialogue_hotspots(map,energy,rx,ry,clmap,clbnd, data)
%creat dialogue box
...
%         exp_directory = uigetdir('C:\Users\Oliver\Documents\STMvideos');
    ...
    function export_Callback(hObject,evendata,map,rx,ry,energy,clmap,clbnd)
        ...
        if isempty(filename)
            ...
            exp_movie_hotspots(map,energy,rx,ry,directory,filename,clmap,clbnd,frps,quality, data);
        end
    end
