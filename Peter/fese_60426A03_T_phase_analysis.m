...
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a03_T_LF_SCC_LF,395, 436);
% % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a03_T_LF_SCC_LF, obj_60426a03_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
...
%% Se vacancy
% % %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_se_atom_integer(obj_60426a03_T_LF_SCC_LF,395, 464);
% % % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a03_T_LF_SCC_LF, obj_60426a03_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% % 
% 
...
%% Fe right
% 
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a03_T_LF_SCC_LF,424, 463);
% 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a03_T_LF_SCC_LF, obj_60426a03_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
% real_prft_topo = prft_topo;
...
[data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a03_T_LF_SCC_LF,395, 436);
% 
[prft_data, prft_topo, clfdata, clftopo, selocex, fe1locex, fe2locex] = fesesingleimpurityphaseanalysis_nosine(obj_60426a03_T_LF_SCC_LF, obj_60426a03_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
...
real_10mV_xmy = abs(mgt1) - abs(mgt2);
real_10mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
imag_10mV_xmy = abs(mgt1) - abs(mgt2);
imag_10mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
ampl_10mV_xmy = abs(mgt1) - abs(mgt2);
ampl_10mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
