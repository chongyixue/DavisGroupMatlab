function data_loc=fese_nem_ord_anal_va(data, varargin)
% va uses the integer rounded position of atoms
% start timer
tic
...
if isempty(varargin)
    ...
    seloc = seloc(sx:ex,sy:ey);
    fe1loc = fe1loc(sx:ex,sy:ey);
    fe2loc = fe2loc(sx:ex,sy:ey);
end
