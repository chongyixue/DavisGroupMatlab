function [res, res2, res3, apl, pha, ift3] = find_envelopes(G,x1,y1,x2,y2,r)
...
mask1 = circle_mask(N,x1,y1,r);
mask2 = circle_mask(N,x2,y2,r);
mask3 = circle_mask(N,x3,y3,r);
mask4 = circle_mask(N,x4,y4,r);
