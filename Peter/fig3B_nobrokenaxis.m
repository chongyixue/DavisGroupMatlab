...
xm_peter = 1.03*[0.15984,0.18981,0.23219, 0.26964,0.28462,0.31458,0.33705,0.34454, 0.36963];
ym_peter = 1.03*[0.05994,0.06993,0.08239, 0.08239,0.0749,0.06741,0.05992,0.05243, 0];

xm1 = xm_peter;
ym1 = ym_peter;

xm_error = 1.03*0.75*[0.04995,0.03996,0.02247, 0.02247,0.02247,0.02247,0.02247,0.02247, 0.02997];
...
%     plot(0, dummy(3),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 1, 0]*cp(i),'MarkerFaceColor',[0, 1, 0]*cp(i)); 
    plot(0, 1.03*dummy(3),'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i+2), :),'MarkerFaceColor',color_map(cp(i+2), :)); 
...
%     plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 0, 1]*cp(i),'MarkerFaceColor',[0, 0, 1]*cp(i)); 
    plot(1.03*dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i+2), :),'MarkerFaceColor',color_map(cp(i+2), :)); 
end  
clear dummy
for i=1:6
     dummy = q3_lorpar(i,1:5);
