%% Fe up
% %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a01_T_LF_SCC_LF,462, 427);
% % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a01_T_LF_SCC_LF, obj_60426a01_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
...
%% Se vacancy
% % %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_se_atom_integer(obj_60426a01_T_LF_SCC_LF,463, 465);
% % % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a01_T_LF_SCC_LF, obj_60426a01_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% % 
% 
...
%% Fe right
% %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a01_T_LF_SCC_LF,495, 467);
% % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a01_T_LF_SCC_LF, obj_60426a01_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
% real_prft_topo = prft_topo;
...
[data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a01_T_LF_SCC_LF,462, 427);
% 
[prft_data, prft_topo, clfdata, clftopo, selocex, fe1locex, fe2locex] = fesesingleimpurityphaseanalysis_nosine(obj_60426a01_T_LF_SCC_LF, obj_60426a01_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
...
real_50mV_xmy = abs(mgt1) - abs(mgt2);
real_50mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
imag_50mV_xmy = abs(mgt1) - abs(mgt2);
imag_50mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
ampl_50mV_xmy = abs(mgt1) - abs(mgt2);
ampl_50mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
