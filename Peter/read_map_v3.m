...
if strcmp(filetype,'1FL')
    filename(end-2:end)='FFL';
elseif strcmp(filetype,'1fl')
    filename(end-2:end)='FFL';
elseif strcmp(filetype,'FFL')
    filename(end-2:end)='FFR';
elseif strcmp(filetype,'ffl')
    filename(end-2:end)='FFR';    
elseif strcmp(filetype,'FFR')
    filename(end-2:end)='TFR';
elseif strcmp(filetype,'TFR')
    con = 0;
elseif strcmp(filetype,'tfr')
    con = 0;    
elseif strcmp(filetype,'2FL')
    filename(end-2:end)='1FL';
elseif strcmp(filetype,'1FL')
    filename(end-2:end)='1FR';
elseif strcmp(filetype,'1FR')
    filename(end-2:end)='TFR';
end
