...
obj_71005A03_T_dc = obj_71005A03_T;
obj_71005A03_T_dc.map = obj_71005A03_T.map;
[dx, dy] = determine_singleimp_center_single_peak(obj_71005A03_T_dc, 1, 55, 62, 2, 2, 'no');

dx = 55;
dy = 62;

comment = 'whitedefect71005a03';

[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71005a03_G, obj_71005A03_T, [dx, dy], 55);
