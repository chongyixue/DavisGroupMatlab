%% Fe up
% %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a02_T_LF_SCC_LF,394, 499);
% % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a02_T_LF_SCC_LF, obj_60426a02_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
...
%% Se vacancy
% % %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_se_atom_integer(obj_60426a02_T_LF_SCC_LF,395, 529);
% % % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a02_T_LF_SCC_LF, obj_60426a02_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% % 
% 
...
%% Fe right
% %
% [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a02_T_LF_SCC_LF,425, 530);
% % 
% [prft_data, prft_topo, clfdata, clftopo] = fesesingleimpurityphaseanalysis(obj_60426a02_T_LF_SCC_LF, obj_60426a02_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
% 
% real_prft_topo = prft_topo;
...
[data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter_integer(obj_60426a02_T_LF_SCC_LF,394, 499);
% 
[prft_data, prft_topo, clfdata, clftopo, selocex, fe1locex, fe2locex] = fesesingleimpurityphaseanalysis_nosine(obj_60426a02_T_LF_SCC_LF, obj_60426a02_T_LF_SCC_LF, [dx, dy], 380, selocex, fe1locex, fe2locex);
...
real_20mV_xmy = abs(mgt1) - abs(mgt2);
real_20mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
imag_20mV_xmy = abs(mgt1) - abs(mgt2);
imag_20mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
...
ampl_20mV_xmy = abs(mgt1) - abs(mgt2);
ampl_20mV_xpy = (abs(mgt1) + abs(mgt2)) / 2;
