function exp_movie_multipanel_dialogue_markers
...
% %%%%%%%%%%%%%%%%%%%%%% CALLBACK FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function sel_data_Callback(hObject,eventdata)
        ...
        eval(['fdata.markers' num2str(panel_n) ' = data']);
    end
    ...
    function export_Callback(hObject,eventdata)
        ...
        if isempty(filename)
            ...
            exp_movie_multipanel_markers(fdata,n_row,n_col,directory,filename,frps,quality);
        end
    end
% 
