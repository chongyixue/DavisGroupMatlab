...
% M point
xg4(3:5) = xm_peter(1:3);
yg4(3:5) = ym_peter(1:3);

xg4(7:11) = xm_peter(4:8);
yg4(7:11) = ym_peter(4:8);
...
xg4(21:25) = fliplr(xm_peter(4:8));
yg4(21:25) = fliplr(ym_peter(4:8));

xg4(27:29) = fliplr(xm_peter(1:3));
yg4(27:29) = fliplr(ym_peter(1:3));
%% if i don't show -1.3 and -1.2
% xg4(5) = xm_peter(1);
% yg4(5) = ym_peter(1);
% 
...
rmap1 = obj_60604A00_G.map;

rmap3 = obj_60606a00_G.map;

rmap2 = obj_60609a00_G.map;

rmapall = cat(3, rmap1, rmap2(:,:,2:end), rmap3(:,:,2:end));

obj_6060469A00_G_markers = obj_60604A00_G;

obj_6060469A00_G_markers.map = rmapall;
obj_6060469A00_G_markers.e = eall;

obj_6060469A00_G_markers.x = xg1;
obj_6060469A00_G_markers.y = yg1;

obj_6060469A00_G_markers.x2 = xg2;
obj_6060469A00_G_markers.y2 = yg2;

obj_6060469A00_G_markers.x3 = xg3;
obj_6060469A00_G_markers.y3 = yg3;

obj_6060469A00_G_markers.x4 = xg4;
obj_6060469A00_G_markers.y4 = yg4;

obj_6060469A00_G_markers.x5 = xg5;
obj_6060469A00_G_markers.y5 = yg5;

obj_6060469A00_G_markers.x6 = xg6;
obj_6060469A00_G_markers.y6 = yg6;

obj_6060469A00_G_markers.xqd = xgqd;
obj_6060469A00_G_markers.yqd = ygqd;