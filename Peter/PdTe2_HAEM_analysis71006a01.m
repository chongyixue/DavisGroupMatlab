...
comment = 'TEST_rectangle_blackdefect71006a01test';

%change crop pixel size accordingly
[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71006a01_G, obj_71006A01_T, [dx, dy], 50);
%use clfdata to choose peaks (also = the map that appears after this)


%% sign-preserving scattering??
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho1] = singleimpuritypdte2analysis2(prft_data, [56, 48], 2, 'ncircle',comment);
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho2] = singleimpuritypdte2analysis2(prft_data, [52, 45], 2, 'ncircle',comment);
...
%%
rho71006a01.rho1 = rho1;
rho71006a01.rho2 = rho2;
rho71006a01.rho3 = rho3;
rho71006a01.rho4 = rho4;
rho71006a01.rho5 = rho5;
rho71006a01.rho6 = rho6;
rho71006a01.rho7 = rho7;
rho71006a01.rho8 = rho8;
rho71006a01.rho9 = rho9;
rho71006a01.rho10 = rho10;


rho71006a01.comment = comment;
%autosave
...
%% center
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho10] = singleimpuritypdte2analysis2(prft_data, [51, 51], 1, 'ncircle',comment);
