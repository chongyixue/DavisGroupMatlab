function [data_loc, dx, dy, selocex, fe1locex, fe2locex] = fesefinddefectcenter(data,gx, gy)
...
[fe1locap, fe1locex] =  atomic_pos_v2(phase_map,pi,0, data);
[fe2locap, fe2locex] =  atomic_pos_v2(phase_map,0,pi, data);
