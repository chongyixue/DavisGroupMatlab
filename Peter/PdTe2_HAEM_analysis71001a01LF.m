...
obj_71001A01_T_dc = obj_71001A01_T_LFCorrect_crop;
obj_71001A01_T_dc.map =  abs(obj_71001A01_T_LFCorrect_crop.map) ;
[dx, dy] = determine_singleimp_center_single_peak(obj_71001A01_T_dc, 1, 56, 62, 4, 4, 'no');

% dx = 61;
% dy = 67;

comment = 'rectangle_blackdefect71001a01_LF';

%change crop pixel size accordingly
[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71001a01_G_LFCorrect_crop, obj_71001A01_T_LFCorrect_crop, [dx, dy], 50);
%use clfdata to choose peaks (also = the map that appears after this)


%% sign-preserving scattering??
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho1] = singleimpuritypdte2analysis2(prft_data, [56,48], 1, 'ncircle',comment);
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho2] = singleimpuritypdte2analysis2(prft_data, [51,45], 1, 'ncircle',comment);
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho3] = singleimpuritypdte2analysis2(prft_data, [46,48], 1, 'ncircle',comment);
