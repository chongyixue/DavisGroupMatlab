...
xm_error = [0.02247, 0.02247,0.02247,0.02247,0.02247,0.02247, 0.02997];
...
plot(xm1(7), ym1(7),'Marker', 'd', 'MarkerSize', p,'MarkerEdgeColor','k','MarkerFaceColor','k');   

hold on

verrorbar(xm1(7), ym1(7), xm_error(7),'k');
herrorbar(xm1(7), ym1(7), xm_error(7),'k');
...
%     plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',[0, 0, 1]*cp(i),'MarkerFaceColor',[0, 0, 1]*cp(i)); 
    plot(dummy(3), 0,'Marker', 'o', 'MarkerSize', p,'MarkerEdgeColor',color_map(cp(i), :),'MarkerFaceColor',color_map(cp(i), :)); 
    if i==1 || i==3 || i==5
        herrorbar(dummy(3), 0,  dummy(5)/2,'k'); 
    end
end  
