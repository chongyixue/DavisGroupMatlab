...
%% both gamma and X
for i=0:120
    s = strcat('C:\Users\pspra\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_', num2str(i), 'conv.mat');
%     s = strcat('C:\Users\Peter\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_', num2str(i), 'conv.mat');
    dummy = load(s);
    quartmap = dummy.rjd0;
...
for i=0:120
    ...
    s = strcat('C:\Users\pspra\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_G_', num2str(i), 'conv.mat');
%     s = strcat('C:\Users\Peter\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_G_', num2str(i), 'conv.mat');
    dummy = load(s);
    quartmap = dummy.rjd0;
    qmlr = fliplr(quartmap);
    qmud = flipud(quartmap);
...
for i=0:120
    ...
    s = strcat('C:\Users\pspra\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_X_', num2str(i), 'conv.mat');
%     s = strcat('C:\Users\Peter\OneDrive\VOSM\QPI layers\11032016Andreas_Tmatrix_matlab\','JDOS_g-0.1_f_222_X_', num2str(i), 'conv.mat');
    dummy = load(s);
    quartmap = dummy.rjd0;
    qmlr = fliplr(quartmap);
    qmud = flipud(quartmap);
