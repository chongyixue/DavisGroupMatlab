...
% cut_q3a = line_cut_v4(obj_60222a00_G_FT,[65, 64],[100, 64],0);
% cut_q3b = line_cut_v4(obj_60222a00_G_FT,[65, 65],[100, 65],0);
% cut_q3c = line_cut_v4(obj_60222a00_G_FT,[65, 63],[100, 63],0);
% cut_q3d = line_cut_v4(obj_60222a00_G_FT,[65, 66],[100, 66],0);
% cut_q3e = line_cut_v4(obj_60222a00_G_FT,[65, 62],[100, 62],0);
% cut_q3f = line_cut_v4(obj_60222a00_G_FT,[65, 67],[100, 67],0);
...
cut_q3 = line_cut_v4(obj_60222a00_G_FT_sym_avg3_bcp,[68, 65],[95, 65],4);
...
q3_lorpar2 = [p.g, p.h, p.k, 2.4, peb2];
q3_lorparcomb(1,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 2.4, abs(p.f - p.k)];
...
q3_lorpar2(2,1:5) = [p.g, p.h, p.k, 2.3, peb2];
q3_lorparcomb(2,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 2.4, abs(p.f - p.k)];
...
q3_lorpar2(3,1:5) = [p.g, p.h, p.k, 2.2, peb2];
q3_lorparcomb(3,1:5) = [p.d, p.e, p.f, 2.2, peb1];
...
guess = [mean(ql), bgsl, min(q) , max(ql)-mean(ql), ws, 0.09244, max(ql)-mean(ql), ws, 0.1257,max(ql)-mean(ql), ws, 0.1523];
...
q3_lorpar2(4,1:5) = [p.g, p.h, p.k, 2.1, peb2];
q3_lorparcomb(4,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 2.1, abs(p.f - p.k)];
...
q3_lorpar2(5,1:5) = [p.g, p.h, p.k, 2.0, peb2];
q3_lorparcomb(5,1:5) = [p.d, p.e, p.f, 2.0, peb1];
...
% exp_lrntz = 'a+ b*(x-c) + d*(e/2)^2/((x-f)^2+(e/2)^2)+g*(h/2)^2/((x-k)^2+(h/2)^2)+l*(m/2)^2/((x-n)^2+(m/2)^2)';
guess = [mean(ql), bgsl, min(q) , max(ql)-mean(ql), ws, 0.09244, max(ql)-mean(ql), ws, 0.1257,max(ql)-mean(ql), ws, 0.1922];
low = [min(ql), bgsldn, -inf,  0,    wdn,  0, 0, wdn, 0, 0, wdn, 0];
upp = [max(ql), bgslup, inf,  max(ql), wup, 0.139*2, max(ql), wup, 0.139*2, max(ql), wup, 0.18*2];
[y_new, p,gof, ci]=FeSe_lorentzian3(ql,q,guess,low,upp);
...
q3_lorpar2(6,1:5) = [p.g, p.h, p.k, 1.9, peb2];
q3_lorparcomb(6,1:5) = [p.d, p.e, p.f, 1.9, peb1];
...
q3_lorpar2(7,1:5) = [p.g, p.h, p.k, 1.8, peb2];
q3_lorparcomb(7,1:5) = [p.d, p.e, p.f, 1.8, peb1];
...
q3_lorpar2(8,1:5) = [p.g, p.h, p.k, 1.7, peb2];
q3_lorparcomb(8,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.7, abs(p.f - p.k)];
%% q3 -1.6 meV
i = 9;
...
q3_lorpar2(9,1:5) = [p.g, p.h, p.k, 1.6, peb2];
% q3_lorparcomb(9,1:5) = [p.d, p.e, p.f, 1.6, peb1];
q3_lorparcomb(9,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.6, abs(p.f - p.k)];
%% q3 -1.5 meV
i = 10;
ql = cut_q3.cut(1:end,i);
q = cut_q3.r(1:end);
...
q3_lorpar2(10,1:5) = [p.g, p.h, p.k, 1.5, peb2];
% q3_lorparcomb(10,1:5) = [p.d, p.e, p.f, 1.5, peb1];
q3_lorparcomb(10,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.5, abs(p.f - p.k)];
...
q3_lorpar2(11,1:5) = [p.g, p.h, p.k, 1.4, peb2];
% q3_lorparcomb(11,1:5) = [p.d, p.e, p.f, 1.4, peb1];
q3_lorparcomb(11,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.4, abs(p.f - p.k)];
...
q3_lorpar2(12,1:5) = [p.g, p.h, p.k, 1.3, peb2];
% q3_lorparcomb(12,1:5) = [p.d, p.e, p.f, 1.3, peb1];
q3_lorparcomb(12,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.3, abs(p.f - p.k)];
...
q3_lorpar2(13,1:5) = [p.g, p.h, p.k, 1.2, peb2];
% q3_lorparcomb(13,1:5) = [p.d, p.e, p.f, 1.2, peb1];
q3_lorparcomb(13,1:5) = [mean([p.d, p.g]), mean([p.e, p.h]), mean([p.f, p.k]), 1.2, abs(p.f - p.k)];
...
% cut_q1e = line_cut_v4(obj_60222a00_BGS,[62, 64],[62, 17],0);
% cut_q1f = line_cut_v4(obj_60222a00_BGS,[67, 64],[67, 17],0);

% cut_q1a = line_cut_v4(obj_60222a00_G_FT,[64, 64],[64, 17],0);
% cut_q1b = line_cut_v4(obj_60222a00_G_FT,[65, 64],[65, 17],0);
% cut_q1c = line_cut_v4(obj_60222a00_G_FT,[63, 64],[63, 17],0);
% cut_q1d = line_cut_v4(obj_60222a00_G_FT,[66, 64],[66, 17],0);
% cut_q1e = line_cut_v4(obj_60222a00_G_FT,[62, 64],[62, 17],0);
% cut_q1f = line_cut_v4(obj_60222a00_G_FT,[67, 64],[67, 17],0);
