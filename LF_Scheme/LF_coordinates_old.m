...
%
% 130514 MHH  - Created
% 20190114-changed this function name LF_coordinates into
% LF_coordinates_old (the new one now has autophase correction)
%%%%%%%%
function [topo_f_x topo_f_y] = LF_coordinates_old(itr,filt_width,phase_cor,data,varargin)
