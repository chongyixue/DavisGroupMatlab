...
function [spline_x,spline_y,dif,leftgap,rightgap,varargout] = spline_fit_avg2(map,order,maxgap,varargin)
...
if nargin==3
    ...
    title(['spline for averaged spectrum with diff order ' num2str(order)])
