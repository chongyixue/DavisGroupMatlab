...
obj_71121A00_T_dc = obj_71121A00_T;
obj_71121A00_T_dc.map = abs( obj_71121A00_T.map );
[dx, dy] = determine_singleimp_center_single_peak(obj_71121A00_T_dc, 1, 71, 70, 5, 5, 'no');

% dx = 61;
% dy = 67;

comment = 'rectangle_blackdefect71121a00';

%change crop pixel size accordingly
[prft_data, prft_topo, clfdata, clftopo] = singleimpurityphaseanalysis(obj_71121a00_G, obj_71121A00_T, [dx, dy], 58);
%use clfdata to choose peaks (also = the map that appears after this)


%% sign-preserving scattering??
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho1] = singleimpuritypdte2analysis2(prft_data, [67,54], 2, 'ncircle',comment);
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho2] = singleimpuritypdte2analysis2(prft_data, [59,50], 2, 'ncircle',comment);
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho3] = singleimpuritypdte2analysis2(prft_data, [51,55], 2, 'ncircle',comment);
...
[realft_data, imagft_data, symrealft_data, symimagft_data, asymrealft_data, asymimagft_data, test_data, rho9] = singleimpuritypdte2analysis2(prft_data, [45,51], 2, 'ncircle',comment);
