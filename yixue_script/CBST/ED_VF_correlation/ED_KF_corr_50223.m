% from peter analysis 50223a00 
% yxc 2019-10-2

% first load the data from peter analysis
% index 4 is 0th LL

smoothenmap = obj_50223A00_G;
[~,~,lay]=size(smoothenmap.map);
for j=1:lay
   smoothenmap.map(:,:,j)=sequencedpeakremoval(obj_50223A00_G.map(:,:,j),5,5,4,4,4,3,3,3,2,2,1,1,1,0.5,0.5);
end
