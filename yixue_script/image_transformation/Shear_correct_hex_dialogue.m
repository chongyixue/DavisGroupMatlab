...
function [new_data,q0,p,theta,alpha,q_px] = Shear_correct_hex_dialogue(data,varargin)
...
fh=figure('Name', 'Shear Correct for Triangular Lattice',...
        'units','normalized', ...
...
%%%%%%%%%%%%%%%%%%%%%%%%CALLBACK FUNCTIONS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function OK_Callback(hobject,eventdata)
        ...
        [new_data,q0,p,theta,alpha] = shear_correct_hex(data,q_px(:,1),q_px(:,2));
        close(fh);
    end
