...
% for (x,y) = (1,1):
peakmV_array = [0,0,100,140,180,202,215,230,0,0,0,0,0,0];
e_array = [-1,0,1,2,3,4]/1000;
background = 2;

map = invert_map(obj_90306a00_G);
ll = fitted_to_viewer(map,llmatrix,background,e_array,'90306a00_llmap_splineminima',peakmV_array);
ll_0 = fitted_to_viewer(map,llmatrix,0,e_array,'90306a00_llmap_no_background',peakmV_array);
ll_1 = fitted_to_viewer(map,llmatrix,1,e_array,'90306a00_llmap_3pointspline',peakmV_array);
...
llmap_combine.name = '90306a00_llmap_combined';
...
llmap_combine_filtered_90306 = llmap_combine;
llmap_combine_filtered_90306.map = replace_with_neighbors(llmap_combine_filtered_90306.map,2);
% for lay = 1:nz
%     llmap_combine_filtered.map(:,:,lay) = removepeaks(llmap_combine.map(:,:,lay),10);
% end
llmap_combine_filtered_90306.name = 'filtered_90306';
llmap_combine_filtered_90306.method = 5;

img_obj_viewer_test(llmap_combine_filtered_90306);
filtered_peakarray = peakmV_array;
range = 5;
llmap_combine_filtered_90306 = filter_misfits(llmap_combine_filtered_90306,peakmV_array,range);
img_obj_viewer_test(llmap_combine_filtered_90306);
