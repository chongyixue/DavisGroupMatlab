% 2019-10-8 YXC testing lorentzianfit function
...
%initialize matrices
pmatrix = zeros(3,nx,ny,18,6);
llmatrix = zeros(3,nx,ny,18);
errmatrix = zeros(3,nx,ny,18);
startmVmatrix = zeros(3,nx,ny,18);
endmVmatrix = zeros(3,nx,ny,18);
