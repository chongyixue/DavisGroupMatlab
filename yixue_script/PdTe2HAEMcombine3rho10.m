...
%6 Oct 2017
clear bigdata;
bigdata(1) = rho71001a01;
bigdata(2) = rho71002a00;
bigdata(3) = rho71006a00;
bigdata(4) = rho71006a01;
bigdata(5) = rho71006a02;
bigdata(6) = rho71009a00;
...
for i=1:ndata
    ...
    bigdata(i).rho(10)=bigdata(i).rho10;
end
